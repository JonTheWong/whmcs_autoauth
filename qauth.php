...
AutoAuth Quote Auto Login v1.1
...
{$whmcs_url}/qauth.php?email={$client_email}&amp;quote={$quote_number}&amp;hash={$hash|md5}

if you would like to place the link inside of a WORD in your template i'd recommend doing.
<a href="https://www.zenithmedia.ca/qauth.php?email={$client_email}&amp;quote={$quote_number}&amp;hash={$hash|md5}">
AUTO QUOTE LOGIN</a>
